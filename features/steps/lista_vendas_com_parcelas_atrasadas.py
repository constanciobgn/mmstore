...
def step_impl(context):
    ...
    context.browser.find_element_by_id('id_data_recebimento').send_keys(f'{ date.today().strftime("%d/%m/%Y") }')
    ...
    wait_for_row_in_list_table(context, 'id_parcela_list_table', '1 6 de Julho de 2018 25,00 Pendente')
